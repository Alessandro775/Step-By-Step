    ...
    return (
        <div className={styles.container}>
            <div className={styles.content}>
                <h2 className={styles.heading}>Cosa sono i DSA?</h2>
                ...
                <h3 className={styles.subheading}>I principali disturbi riconosciuti come DSA sono:</h3>
                ...
                <h3 className={styles.subheading}>Il nostro progetto: supporto mirato per dislessia e disortografia</h3>
                <p className={styles.text}>
                ...
                <h3 className={styles.subheading}>Cosa offriamo:</h3>
                <ul className={styles.text}>
                ...
                <h3 className={styles.subheading}>La nostra missione</h3>
                <p className={styles.text}>
