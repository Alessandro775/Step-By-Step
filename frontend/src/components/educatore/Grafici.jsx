...
const Grafici = ({ chartData, errorsAttemptsData, showCharts, onToggleCharts }) => {
    return (
        <>
            {/* Pulsante per Mostrare/Nascondere i Grafici nell'header */}
            ...
            {/* Sezione Grafici dell'Andamento - Conditional Rendering */}
            {showCharts && (chartData.length > 0 || errorsAttemptsData.length > 0) && (
